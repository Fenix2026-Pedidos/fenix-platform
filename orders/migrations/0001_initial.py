    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('new', 'Nuevo'), ('confirmed', 'Confirmado'), ('preparing', 'Preparando'), ('out_for_delivery', 'En reparto'), ('delivered', 'Entregado'), ('cancelled', 'Cancelado')], default='new', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('status', models.CharField(choices=[('new', 'Nuevo'), ('confirmed', 'Confirmado'), ('preparing', 'Preparando'), ('out_for_delivery', 'En reparto'), ('delivered', 'Entregado'), ('cancelled', 'Cancelado')], max_length=20)),
                ('note', models.TextField(blank=True)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('created_by', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='order_events', to=settings.AUTH_USER_MODEL)),
